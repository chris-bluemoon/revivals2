...
class AccountsHistoryImageWidget extends StatelessWidget {
  AccountsHistoryImageWidget(this.fittingRenter, this.bookingDate, this.price, this.status, {super.key});
